<template>
  <div>
    <div
      v-if="!emailVerified && user"
      class="alert alert-warning text-center rounded-0"
    >
      <strong>Action required:</strong>
      Please verify your account within <b>30 days of signup</b> from
      <NuxtLink to="/admin" class="text-decoration-underline">
        My Profile
      </NuxtLink>
              ...
              <div class="col-md-10">
                <div class="banner-content">
                  <div class="d-flex align-items-center mb-3">
                    ...
                    <h4 class="mb-0 fw-bold text-dark">Public Demo Instance</h4>
                  </div>
